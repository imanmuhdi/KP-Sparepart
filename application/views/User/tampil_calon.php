        ...
        <div class="content">
            <form action="<?php echo site_url('calon/prosesupdate/'.$calon->id_calon); ?>" method="post" enctype="multipart/form-data">
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            <input type="text" name="nama" required="Nama Calon" value="<?php echo $calon->nama_calon?>" readonly>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <textarea rows="10" cols="100" name="visi" required="Visi" readonly><?php echo $calon->visi?></textarea>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            <textarea rows="10" cols="100" name="misi" required="Misi" readonly><?php echo $calon->misi?></textarea>
                        </td>
                    </tr>
